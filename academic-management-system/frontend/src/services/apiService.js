...
export const adminApi = {
  ...
  getFacultyAllocations: (semesterId, academicYearId) => get('/faculty-allocations', { semesterId, academicYearId }).catch(() => get('/admin/faculty', { semesterId, academicYearId })),
  createFaculty: (data) => post('/admin/faculty', data),
  createFacultyAllocation: (data) => post('/faculty-allocations', data),
  assignFacultyCourse: (data) => post('/faculty-allocations', data).catch(() => post('/admin/faculty/assignments', data)),
  updateFacultyAssignment: (assignmentId, data) => patch(`/admin/faculty/assignments/${assignmentId}`, data),
  deleteFacultyAssignment: (assignmentId, semesterId, academicYearId) => del(`/faculty-allocations/${assignmentId}`).catch(() => del(`/admin/faculty/assignments/${assignmentId}`, { semesterId, academicYearId })),
  allocateFaculty: (data) => post('/faculty-allocations', data).catch(() => post('/admin/faculty/assignments', data)),
  removeAllocation: (id) => del(`/faculty-allocations/${id}`).catch(() => del(`/admin/faculty/assignments/${id}`)),
