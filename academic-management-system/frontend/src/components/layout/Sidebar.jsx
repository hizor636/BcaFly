...
export const PLATFORM_NAV = {
  ADMIN: [
    ...
    { path: '/admin/attendance', label: 'Semester Attendance', icon: '⏱️' },
    { path: '/admin/marks', label: 'Semester Assessment', icon: '📝' },
    { path: '/admin/results', label: 'Semester Results', icon: '🏆' },
    { path: '/admin/activities', label: 'Activity Portfolios', icon: '🎖️' },
